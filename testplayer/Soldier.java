...
public class Soldier
{
    ...
    // Global storage object, this gets passed from RobotPlayer and gets set on run()
    private static Storage know;
        ...
        throws GameActionException
    {
        ...
        double distEnemyHQ = Math.sqrt(coord.distanceSquaredTo(Storage.ENEMY_HQ));
        ...
        double distBetween = Math.sqrt(
                rc.senseHQLocation().distanceSquaredTo(Storage.ENEMY_HQ));
