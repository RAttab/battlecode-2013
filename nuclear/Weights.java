...
public class Weights
{
    ...
    public static final double CAPTURE      = 3.0;
    ...
    public static final double MILITARY     = 1;
    ...
    public static final double LAY_MINE     = 0.5;
    public static final double NEARBY_MINE  = 0.1;
